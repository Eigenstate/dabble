...
#
#
# $Id: timeline.tcl,v 1.97 2014/12/22 17:25:08 barryi Exp $
      ...
      foreach seg $segList {
        ...
        for {set id_i $id_begin} {$id_i <= $id_end} {incr id_i} {
          ...
          #tlPutsDebug "id_i = $id_i ss_0 = $ss_0 ss_1 = $ss_1"
            ...
            # 
          if {$ss_0 != $ss_1} {
            set ssSel [atomselect $currentMol "segid $seg and (resid $id_0 to $id_i)" frame $trajFrame]
            ...
            if {![string is double $CCSS]|| $CCSS != $CCSS } {
              ...
              tlPutsDebug "VMD WARNING: CrossCorr NaN found.  trajFrame= $trajFrame  sel. text: segid $seg and (resid $id_0 to $id_i)  . num in userSel = [$ssSel num] "
              set CCSS -1.0
            }
            ...
            set scaling [expr {double($id_i - $id_0 + 1) / double($partNum)}]
