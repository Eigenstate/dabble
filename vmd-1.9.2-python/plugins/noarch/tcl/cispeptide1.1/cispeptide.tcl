...
#
# $Id: cispeptide.tcl,v 1.19 2013/04/15 15:39:20 johns Exp $
#
...
package provide cispeptide 1.1
...
proc ::cispeptide::cispeptide_check { args } {
  ...
  set count [::cispeptide::cispeptide_check_core $indO $indC $indN $indCA $molid]
...
# peptide bond.
proc ::cispeptide::cispeptide_check_core {indO indC indN indCA molid} {
...
proc ::cispeptide::cispeptide_show { args } {
  ...
  $sel delete
  molinfo $molid set center [list $center]
  scale to 0.5
  translate to 0 0 0
  display update
