...
##          vmd@ks.uiuc.edu
##
## $Id: autopsf.tcl,v 1.123 2013/02/21 23:37:38 petefred Exp $
##
## Home Page:
...
namespace eval ::autopsf:: {
   ...
   variable oseltext   "protein or nucleic";         # User provided selection text. This part will be built by psfgen. 
...
proc ::autopsf::split_protein_and_water_pdb { fname } {
   ...
   foreach line [split [read -nonewline $in] \n] {
	  ...
	  set resname [string trim [string range $line 17 20]]
	  set curseg  [string trim [string range $line 72 75]]
      set curchain [string index $line 21]
	  set curres  [string trim [string range $line 22 25]]
#	  set residstarts
#	  set residends
	  ...
	  if {$nofailedguess} {
		...
		lappend zerocoord [list $curseg $curres $name]
          ...
          if { $resname=="HOH " || $resname=="TIP3" || $resname == "TIP4" || $resname == "TP4E" || $resname == "TP4V" || $resname == "TP3E" || $resname == "SPCE" || $resname == "SPC"} { 
	     set curwater 1 
          } 
