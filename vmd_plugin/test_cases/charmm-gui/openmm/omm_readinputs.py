...
class _OpenMMReadInputs():
    ...
    def __init__(self):
        self.toppar_path	= None
        self.input_psf		= None
        self.input_box		= None
        self.input_crd		= None
        self.input_rst		= None
        self.input_chk		= None
        self.output_dcd		= None
        self.output_rst		= None
        self.output_chk		= None
    ...
    def read(self, inputFile):
        for line in open(inputFile, 'r'):
            ...
            if len(line) > 0:
                ...
                if input_value:
                    if input_param == 'TOPPAR_PATH':                    self.toppar_path = input_value
                    if input_param == 'INPUT_PSF':                      self.input_psf   = input_value
                    if input_param == 'INPUT_BOX':                      self.input_box   = input_value
                    if input_param == 'INPUT_CRD':                      self.input_crd   = input_value
                    if input_param == 'INPUT_RST':                      self.input_rst   = input_value
                    if input_param == 'INPUT_CHK':                      self.input_chk   = input_value
                    if input_param == 'OUTPUT_DCD':                     self.output_dcd  = input_value
                    if input_param == 'OUTPUT_RST':                     self.output_rst  = input_value
                    if input_param == 'OUTPUT_CHK':                     self.output_chk  = input_value
